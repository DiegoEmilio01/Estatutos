	...
	\section{Elecciones, requisitos y sanciones}\label{elecciones}
		...
		\begin{art}\label{eleccionesCAi}
			...
			\begin{enumerate}
				...
				\item Una vez cerrado el proceso de inscripción, si alguna de las listas debe modificar a sus candidatos sólo puede realizar un cambio entre el resto de los miembros de la misma. Esto podrán hacerlo siempre y cuando continúen cumpliendo con lo establecido en el inciso \ref{} E.
